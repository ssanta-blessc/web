...
<template>
    <div>
        <div v-if="group" class="flex flex-col w-full min-h-full">
            ...
            <Admin v-if="group.admin && !group.closed" @game-started="group.closed = true" />
            <WishTextAreaComponent v-if="!group.admin && !group.closed" placeholder="Ваше желание" class="flex flex-col h-full" />
